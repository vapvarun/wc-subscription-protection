...
class Wbcom_WC_Subscription_Content_Protection {
    ...
    public function wbcom_protection_meta_box_callback($post) {
        ...
        ?>
        <style>
        .wc-protection-field { margin-bottom: 15px; }
        .wc-protection-field label { display: block; font-weight: bold; margin-bottom: 5px; }
        .wc-protection-field input[type="checkbox"] { margin-right: 8px; }
        .wc-protection-field textarea { width: 100%; height: 80px; }
        .wc-protection-products { max-height: 150px; overflow-y: auto; border: 1px solid #ddd; padding: 10px; background: #f9f9f9; }
        </style>
...
// CSS Styles (save this in assets/style.css)
?>
<style>
/* Frontend Styles */
...
.wbcom-subscription-protection-message h3 {
    color: #495057;
    margin-bottom: 15px;
    font-size: 24px;
}

.wbcom-subscription-protection-message p {
    color: #6c757d;
    margin-bottom: 20px;
    font-size: 16px;
    line-height: 1.5;
...
.required-subscriptions ul {
    list-style-type: none;
    padding: 0;
    margin: 10px 0 0 0;
}

.required-subscriptions li {
    margin-bottom: 8px;
}

.required-subscriptions a {
    color: #007cba;
    text-decoration: none;
    font-weight: 500;
}

.required-subscriptions a:hover {
...
.wbcom-protection-field input[type="checkbox"] { 
    margin-right: 8px; 
}
